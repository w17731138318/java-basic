...
- [2. 创建和销毁对象](#2-creating-and-destroying-objects)
	- [1. 用静态工厂方法替代构造器](#1-use-static-factory-methods-instead-of-constructors)
	- [2. 遇到多个构造器参数时要考虑使用构建器](#2-use-builders-when-faced-with-many-constructors)
	- [3. 用私有构造器或枚举类强化Singleton属性](#3-enforce-the-singleton-property-with-a-private-constructor-or-an-enum-type)
	- [4. 通过私有构造器强化不可实例化的能力](#4-enforce-noninstantiablillity-with-a-private-constructor)
	- [5. 避免创建不必要的对象](#5-avoid-creating-objects)
	- [6. 消除过期的对象引用](#6-eliminate-obsolete-object-references)
	- [7. 避免使用终结方法](#7-avoid-finalizers)
